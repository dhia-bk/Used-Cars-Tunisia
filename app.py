...
def understand_the_market():
    ...
    # Calculate bins for legend
    max_count = max(country_counts.values())
    legend_bins = [x for x in range(0, max_count + 500, 500)]
    
    # Add Choropleth layer to color countries based on count of cars
    choropleth = folium.Choropleth(
        geo_data='EDA Data/custom.geo.json',
        name='choropleth',
        data=country_counts,
 ...
 return render_template('Understand the Market.html',{'fig1' : map_json})
